...
local getcustomassets = {
	...
	['newvape/assets/new/guivape.png'] = 'rbxassetid://109472188250623',
	...
	['newvape/assets/new/textvape.png'] = 'rbxassetid://109472188250623',
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/zuyv/RelicV4/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
